...
// 書籍情報のルーティング
Route::middleware('web')->group(function () {       // Advanced:webルート明示
...
Route::get('books/isbn/{isbn}', [BookController::class, 'searchByIsbn'])->name('books.searchByIsbn'); // Advanced:ISBN検索
